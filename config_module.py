...
if __name__ == "__main__":
    # DATA_FILE is the file we want to load
    def df_loaded_from_file(file: str) -> pd_config.DataFrame:
        """Loads a CSV file into a pandas DataFrame."""
        print("Now loading ...\n...")
        ready_df = pd_config.read_csv(file)
        print("Dataframe has been successfully loaded!")
        return ready_df
    df_loaded_from_file(DATA_FILE)
    print()
